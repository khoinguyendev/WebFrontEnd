  ...
  return (
    <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
      ...
      <div
        ...
        style={{ position: "absolute", inset: "0px 0px auto auto", margin: 0, transform: "translate(-375px, 81px)" }}
      ...
      >
        ...
        <div data-popper-arrow style={{ position: "absolute", left: 0, transform: "translate(271px, 0px)" }} />
      </div>
      ...
      <div className="flex items-center justify-between pt-3 mt-5 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
        <div>
          ...
          <div
            ...
            id="stats-dropdown"
            style={{ position: "absolute", inset: "0px auto auto 0px", margin: 0, transform: "translate(957px, 301px)" }}
