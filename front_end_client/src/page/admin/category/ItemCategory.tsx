  ...
  return (
    <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
        <img src={`${SERVER_HOST}/uploads/${category.image}`} alt="Uploaded" className="w-20 h-20 object-cover rounded" />
      </td>
      <td className="text-base font-semibold text-gray-900 dark:text-white">{category.position}</td>
      <td className="text-base font-semibold text-gray-900 dark:text-white">{category.showHome ? "Có" : "Không"}</td>
